...
if 'OVERRIDE_CORES' in os.environ:
    try:
        OVERRIDE_CORES = int(os.environ['OVERRIDE_CORES'])
    except ValueError:
        pass
...
if 'OVERRIDE_MEMORY' in os.environ:
    try:
        OVERRIDE_MEMORY = int(os.environ['OVERRIDE_MEMORY'])
    except ValueError:
        pass
