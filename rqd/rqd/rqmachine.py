...
class Machine(object):
    ...
    def __init__(self, rqCore, coreInfo):
        ...
        self.__vmInfo = rqd.rqutil.getVmInfo()
    ...
    def __initMachineStats(self, pathCpuInfo=None):
        ...
        if self.__vmInfo:
            if self.__vmInfo["FRAME_ID"]:
                self.__renderHost.attributes['FRAME_ID'] = self.__vmInfo["FRAME_ID"]
            if self.__vmInfo["RENDER_NODE_ID"]:
